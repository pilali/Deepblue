...
// RBJ cookbook biquad — LP / HP / BP. setup() only recomputes coefficients;
// the filter state is preserved, so it is safe to call once per block while
// the cutoff is being modulated, without clicks.
class Biquad {
public:
